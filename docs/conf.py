...
templates_path = ["."]
extlinks = {
    "issue": ("https://github.com/DaanVanVugt/ymmsl-dot/issues/%s", "#"),  # noqa: E501
    "pr": ("https://github.com/DaanVanVugt/ymmsl-dot/pull/%s", "PR #"),  # noqa: E501
}
...
linkcheck_ignore = [
    r"https://codecov.io/gh/DaanVanVugt/ymmsl-dot/*",
]
